...
```bash
poetry install
poetry run python -m api_template
```
...
```
docker run -p "5432:5432" -e "POSTGRES_PASSWORD=api_template" -e "POSTGRES_USER=api_template" -e "POSTGRES_DB=api_template" postgres:13.8-bullseye
```
